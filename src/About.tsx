...
export default function About() {
  return (
    <div 
      ...
      style={{ minHeight: "100vh", fontFamily: "Victor mono" }}
    >
      <Container>
        <Row className="justify-content-center">
          <Col lg={8} className="text-center">
            ...
            <h1 
              ...
              style={{ fontSize: "52px", fontFamily: "'Victor mono" }}
            >
            ...
            >
              I am an <strong>I.T. student</strong> living in <strong>La Trinidad</strong>, I enjoy messing around with codes at times. Though I kind of prefer
              dealing with arts, like taking pictures, drawing things, or even recording stuff. Though I am not really that good at it. 
            ...
            >
              ...
              It is like capturing a moment and immortalizing it. Though of course it really won't be like that.
              Just the idea of it seems a little romantic, nostalgic, and of course practical.
            ...
            <ul 
              className="list-unstyled d-flex flex-wrap justify-content-center gap-3 mb-0"
            >
              <li 
